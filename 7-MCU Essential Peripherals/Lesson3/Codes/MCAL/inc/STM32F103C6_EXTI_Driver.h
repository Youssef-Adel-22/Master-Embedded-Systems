...
typedef struct
{
	EXTI_GPIO_MAPPING_t EXTI_PIN;							//specifies the external interrupt GPIO mapping
															//this must be set based on @ref EXTI_define
	uint8_t 			Trigger_Edge;						//specifies the external interrupt desired edge detection
															//this must be set based on @ref EXTI_Trigger_Edge
	uint8_t 			IRQ_State;							//Enable/Disable the external interrupt (Will Enable/Disable EXTI on IRQ mask and NVIC  )
															//this must be set based on @ref EXTI_Enable/Disable
	void(*Ptr_IRQ_callBack)(void);							//Set your ISR which will be called when IRQ happen
...
//@ref EXTI_Enable/Disable
#define EXTI_IRQ_Disable		0
#define EXTI_IRQ_Enable			1

//@ref EXTI_Trigger_Edge
#define Rising_Edge		0
#define Falling_Edge	1
#define Change_Edge		2
